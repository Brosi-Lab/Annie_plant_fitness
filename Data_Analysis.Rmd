...
delph = read.csv("~/Documents/BROSI/THESIS/Data Cleaning/Delphinium_final2.csv") # read in the data
...
#install.packages("lme4")
library(lme4) # this you need to do in every R session 
mert = read.csv("~/Documents/BROSI/THESIS/Data Cleaning/Mertensia_final2.csv") # read in the data
...
#install.packages("lme4")
library(lme4) # this you need to do in every R session 
pot = read.csv("~/Documents/BROSI/THESIS/Data Cleaning/Potentilla_final2.csv") # read in the data
...
```{r importing data}
masterdata=read.csv("~/Documents/BROSI/THESIS/Data Cleaning/Mertensia_final.csv")
