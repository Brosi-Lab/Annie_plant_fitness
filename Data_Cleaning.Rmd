...
Mertensia.final$midpoint<- Mertensia.final$bloom.start + floor((Mertensia.final$end.estimate-Mertensia.final$start.estimate)/2)
...
#Finding midpoint between start and end estimates
Potentilla.final$midpoint<- Potentilla.final$bloom.start + floor((Potentilla.final$end.estimate-Potentilla.final$start.estimate)/2)
#Converting midpoint to Julian date
...
#Finding midpoint between start and end estimates
Delphinium.final$midpoint<- Delphinium.final$bloom.start + floor((Delphinium.final$end.estimate-Delphinium.final$start.estimate)/2)
#Converting midpoint to Julian date
