...
Potentilla.final$end.estimate<-as.Date(ifelse(is.na(Potentilla.final$end.estimate), Potentilla.final$end.estimate.modified, Potentilla.final$end.estimate)) #compiling the calculated end estimates and actual end estimates
```
