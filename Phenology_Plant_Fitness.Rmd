...
pot$midpoint2<-format(as.Date(pot$midpoint), format="%m-%d")

ggplot(pot,aes(x=pot$midpoint2, y=pot$total.seeds, group= pot$treat)) +
  labs(y="Total Developed Seeds",x="Date", title="Effect of Potentilla Blooming Time and Pollinator Activity on Total Developed Seeds") +
  theme_classic() +
  geom_point(size=3, alpha = 0.8, aes(color=treat)) +
  geom_smooth(aes(color=treat)) +
  scale_color_brewer(palette="Dark2") + 
  ...
  scale_color_manual(labels= c("open","open-hand"), values = c("open"="darkred","open-hand"="darkorange")) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  annotate("rect",xmin="07-05", xmax="08-24",ymin=0,ymax=Inf,alpha=0.1)
```
...
```{r Mertensia prop poll act plot, message=FALSE}
ggplot(mert, aes(x=mert$midpoint2, y=mert$prop.dev.seeds, group= mert$treat)) +
  labs(y="Proportion of Developed Seeds",x="Date", title="Effect of Mertensia Blooming Time and Pollinator Activity on Proportion of Developed Seeds") +
  theme_classic() +
  geom_point(size=3, alpha = 0.8, aes(color=treat)) +
  geom_smooth(aes(color=treat)) +
  scale_color_brewer(palette="Dark2") + 
...
```{r delph poll act prop plot, message=FALSE}
ggplot(delph, aes(x=as.Date(delph$midpoint2), y=delph$prop.dev.seeds, group= delph$treat)) +
  labs(y="Proportion of Developed Seeds",x="Date", title="Effect of Delphinium Blooming Time and Pollinator Activity on Proportion of Developed Seeds") +
  theme_classic() +
  geom_point(size=3, alpha = 0.8, aes(color=treat)) +
  geom_smooth(aes(color=treat)) +
  scale_color_brewer(palette="Dark2") + 
  ...
  scale_color_manual(labels= c("open","open-hand"), values = c("open"="darkred","open-hand"="darkorange")) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  annotate("rect",xmin=as.Date("2019-06-27"), xmax=as.Date("2019-07-18"),ymin=0,ymax=Inf,alpha=0.1) +
