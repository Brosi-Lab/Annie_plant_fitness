...
```{r checking binom dist, warning=FALSE,message=FALSE}
mert.open<-mert.open[!is.na(mert.open$prop.dev.seeds),]
...
```{r checking delph binom dist, warning=FALSE,message=FALSE}
delph.open<-delph.open[!is.na(delph.open$prop.dev.seeds),]
