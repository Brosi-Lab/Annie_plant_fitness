...
mert$seeds.per.flower<-(mert$dev.seed/mert$flowers)
...
delph$seeds.per.flower<-((delph$dev.seed1+delph$dev.seed)/delph$X.flowers)
...
pot$seeds.per.flower<-((pot$dev.seed.sharp+pot$dev.seed.rest)/pot$X.flowers)
...
```{r main hurdle model with lme4, warning=FALSE}
...
```{r delph hurdle model with lme4, warning=FALSE}
...
```{r pot hurdle model with lme4, warning=FALSE}
