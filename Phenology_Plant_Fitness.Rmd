...
The seed set of Delphinium individuals was significantly affected by main effects of deviation, blooming early vs. late, and conspecific density, as well as the interaction effects. Deviation had a negative effect on the proportion of developed seeds, with a greater negative effect on early blooming indivdiuals. Conspecific density had a positive effect, with a greater positive effect on the later blooming individuals. Our model was not overdispersed. 

**When flower number is taken into account, early blooming individuals that deviate from the population peak experience lower seed set, and unmanipulated late blooming individuals benefit from conspecific pollen donors.**
...
Delphinium proportions of developed seeds were significantly affected by pollen supplementation, and the data were not overdispersed to the binomial.
