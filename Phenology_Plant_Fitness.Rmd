...
ggplot(mert, aes(x=mert$deviation, y=mert$total.seeds, group= mert$early.late)) +
  labs(y="Total Developed Seeds",x="Days Relative to Population Peak Bloom", title="Effect of Mertensia Deviation from Peak on Total Developed Seeds") +
  geom_point(size=3, alpha = 0.8) +
  scale_color_brewer(palette="Dark2") + labs(color="Early or Late") +
  scale_color_manual(labels= c("early","late"), values = c("early"="darkgreen","late"="darkorange")) +
  geom_smooth(method="glm",aes(color=early.late),yintercept=53)
```
...
ggplot(mert, aes(x=mert$number.conspecifics, y=mert$total.seeds, group= mert$plot.treat)) +
  ...
  geom_point(size=3, alpha = 0.8) +
  scale_color_brewer(palette="Dark2") + labs(color="control or manip") +
  scale_color_manual(labels= c("control","manip"), values = c("control"="darkgreen","manip"="darkorange")) +
...
ggplot(delph, aes(x=delph$deviation, y=delph$total.seeds, group= delph$early.late)) +
  ...
  scale_color_brewer(palette="Dark2") + labs(color="Early or Late") +
  scale_color_manual(labels= c("early","late"), values = c("early"="darkgreen","late"="darkorange")) +
  geom_smooth(method="glm",aes(color=early.late),yintercept=mean(delph$total.seeds[delph$deviation==0]))
```
...
ggplot(pot, aes(x=pot$deviation, y=pot$total.seeds, group= pot$early.late)) +
  ...
  scale_color_brewer(palette="Dark2") + labs(color="Early or Late") +
  scale_color_manual(labels= c("early","late"), values = c("early"="darkgreen","late"="darkorange")) +
  geom_smooth(method="glm",aes(color=early.late),yintercept=mean(pot$total.seeds[pot$deviation==0]))
```
