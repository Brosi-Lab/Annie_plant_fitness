...
ggplot(mert, aes(x=mert$deviation, y=mert$total.seeds, group= mert$early.late)) +
  ...
  labs(color="Plot Treatment",linetype="Early or Late") +
  geom_smooth(method="glm",aes(linetype=early.late),color="black") +
...
ggplot(mert, aes(x=mert$number.conspecifics, y=mert$prop.dev.seeds, group= mert$plot.treat)) +
  ...
  scale_color_brewer(palette="Dark2") + labs(color="Plot Treatment") +
  scale_color_manual(labels= c("control","manip"), values = c("control"="darkgreen","manip"="darkorange")) +
  geom_smooth(method="glm",aes(color=plot.treat)) + theme_classic()
```
...
ggplot(delph, aes(x=delph$number.conspecifics, y=delph$prop.dev.seeds, group= delph$plot.treat)) +
  ...
  scale_color_brewer(palette="Dark2") + labs(color="Plot Treatment") +
  scale_color_manual(labels= c("control","manip"), values = c("control"="darkgreen","manip"="darkorange")) +
  geom_smooth(method="glm",aes(color=plot.treat)) + theme_classic() + xlim(0,110)
```
