...
```{r Mertensia plot, message=FALSE}
...
```{r Delphinium plot,message=FALSE}
...
```{r Potentilla plot,message=FALSE}
...
```{r Mertensia proportion plot,message=FALSE}
...
```{r Delphinium proportion model,warning=FALSE}
...
```{r Delphinium proportion plot,message=FALSE}
