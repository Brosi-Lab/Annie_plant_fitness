...
mert.glmmtmb<-glmmTMB(dev.seed ~ flowers:deviation*early.late + number.conspecifics/plot.treat + rate + (1|site), ziformula=~1, family = "nbinom2", data = mert.open) #putting count data into glmmTMB for DHARMa package
summary(mert.glmmtmb) #summary of glmmTMB model
